...
import sunrise from '../assets/images/backgrounds/sunrise.jpg';
    ...
    <div className="bg-light p-5">
      ...
      <div className="card mb-md-3 bg-light">
        <div className="row no-gutters">
              <img src={sunrise} className="h-25 card-img-top" alt="..." />
            <div className="card-body p-md-5">
              <p class="card-text">I am committed to a stress-free experience, every time. Here’s what else you can expect from your first session.</p>

              <h2 class="card-text">1. MEET AND GREET</h2>
              ...
              <h2 class="card-text">2.  STARTING YOUR MASSAGE SESSION</h2>
              ...
              <h2 class="card-text">3. DURING YOUR MASSAGE</h2>
              ...
              <h2 class="card-text">4. FOLLOW UP DISCUSSION</h2>
              ...
              <h2 class="card-text">5. CANCELLATION POLICY</h2>
