export default [
    ...
    }, 
    {
        ...
        intro: '<p>Enhance your performance during your next sports event. Targeted therapy focussed on muscles used in the athlete\'s particular sport.<p>',
        details: '<p>Sports massage is usually performed on a client dressed in loose clothing and involves applying therapeutic massage and stretching to assist an athlete’s performance or speed recovery from an activity. Generally pre-event massage happens the day of or one day prior to your event. The focus is preparing for high intesisty activitiy.</p>',
        icon: 'running',
        featureImage: '/assets/images/featureImage/massage.jpg',
        slug: 'pre-event',
    }, 
    {
        ...
        intro: '<p>Speed your recovery with a massage focussed on enhancing circulation and reducing muscle tension.<p>',
        details: '<p>Sports massage is usually performed on a client dressed in loose clothing and involves applying therapeutic massage and stretching to assist an athlete’s performance or speed recovery from an activity. Generally post-event massage happens within 72 hours of completing your event. The focus is recovering from high intesisty activitiy, increasing circulation and reducing musle tension.</p>',
        icon: 'swimmer',
        featureImage: '/assets/images/featureImage/massage.jpg',
        slug: 'post-event',
    }, 
    ...
    },
    {
        ...
        intro: '<p>Full-person customized program, tailored to your fitness goals. Fuel your motivation and make exercise fun and exciting.<p>',
    ...
    }, 
    {
        ...
        intro: '<p>Strength training specifically designed to improve the performance of athletes and prevent injury.<p>',
        details: '<p>I DON’T JUST POINT YOU IN THE RIGHT DIRECTION, I HAND DELIVER YOU THERE.</p><p>As a certified personal trainer I work with you to create a goal-based program that keep your workouts fresh, fuel your motivation and make exercise fun and exciting.</p><p>Whether you’ve been working out for years or are planning to start, I will tailor a training regimen to suit your individual needs, schedule, and budget.</p>',
        icon: 'dumbbell',
        featureImage: '/assets/images/featureImage/weights.jpg',
        slug: 'personal-training',
